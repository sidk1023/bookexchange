...
<body style = "background-color: #eee">
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <h1 style="text-align: center;color: black;" >Edit Book</h1>
    <div class="container py-5 h-100">
        <div class="row d-flex justify-content-center align-items-center h-100">
          <div class="col col-lg-6 mb-4 mb-lg-0">
    <form action="submiteditbookadmin" method = "post">
        <!-- 2 column grid layout with text inputs for the first and last names -->
        <div class="row mb-4">
          <div class="col">
            <div class="form-outline">
                <label class="form-label" for="form6Example1">Title</label>
              <input type="text" id="form6Example1" class="form-control" value = ${book.title}  name="title" />
            </div>
          </div>
        ...
        <div class="form-outline mb-4">
          ...
          <input type="text" id="form6Example5" class="form-control" value = ${book.author} name = "author"/>
        ...
        <div class="form-outline mb-4">
          ...
          <input type="text" id="form6Example6" class="form-control"  value = ${book.description} name = "description" />
