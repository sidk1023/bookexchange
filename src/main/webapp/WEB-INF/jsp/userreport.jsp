...
<section class="container-fluid" style="background-color:#e7e0da">
    <h1 class="py-5" style="text-align:center; color: #703f37;">User Books</h1>
    <div class="container">
        <div class="row row-cols-3">
...
<section class="container-fluid" style="background-color:#e7e0da">
    <h1 class="py-5" style="text-align:center; color: #703f37;">User Requests</h1>
    <div class="container">
        <div class="row row-cols-3">
...
<section class="container-fluid" style="background-color:#e7e0da">
    <h1 class="py-5" style="text-align:center; color: #703f37;">View All Lend Requests</h1>
    <div class="container">
        <div class="row row-cols-3">
            <c:forEach items="${requestLent}" var="request">
                <div class="card d-inline-flex mt-4 ms-4" style="width: 20rem;">
                    <div class="card-body">
                      <h5 class="card-title">${request.book.title}</h5>
                      <p class="card-text">
